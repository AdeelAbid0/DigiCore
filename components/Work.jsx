            ...
            >
              ...
              <div className="w-full md:w-2/5">
                <div className="flex items-center gap-4 mb-4">
                  <span className="px-3 py-1 rounded-full border border-white/20 text-xs uppercase tracking-wider text-gray-400">
                    {project.year}
                  </span>
                ...
                <p className="text-xl text-gray-400 mb-6">
                  The goal was to redefine the digital presence of{" "}
                  {project.title} to match their evolving market position.{" "}
                </p>
                <Link
                  href={`/project/${project.slug}`}
