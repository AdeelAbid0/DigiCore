    ...
    <section id="work" className="py-24 bg-dark">
      <div className="max-w-7xl mx-auto px-6">
        <div className="mb-16">
          ...
          >
            Selected Work <span className="text-gray-600 block md:inline">2023-24</span>
          </motion.h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="w-full md:w-2/5">
                ...
                <p className="text-xl text-gray-400 mb-6">The goal was to redefine the digital presence of {project.title} to match their evolving market position. </p>
                <Link 
                    href={`/project/${project.slug}`}
