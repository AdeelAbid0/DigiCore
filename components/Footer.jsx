...
const Footer = () => {
  return (
    <footer
      id="contact"
      className="bg-black pt-24 pb-8 border-t border-white/10"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
          ...
          <div>
            <h2 className="text-5xl md:text-7xl font-display font-bold leading-none mb-8">
              Ready to build? <br />
              <span className="text-gray-500">Let's launch it together.</span>
            </h2>
            <a
              href="mailto:hello@digicore.tech"
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              <h4 className="text-gray-500 mb-6 font-mono uppercase text-sm">
                Sitemap
              </h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/10 text-sm text-gray-500">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            <div className="w-6 h-6 flex items-center justify-center rounded">
              <img src="/logo-short.png" alt="" />
            </div>
            <span>© 2026 DigiCore Tech Solutions. All rights reserved.</span>
          </div>
